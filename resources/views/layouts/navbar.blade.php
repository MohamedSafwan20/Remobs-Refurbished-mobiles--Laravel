<nav class="navbar navbar-expand-lg navbar-dark bg-primary p-3 d-flex justify-content-between shadow fixed-top">
    ...
    @else
    <form action={{ route('productDetails') }} method="GET" class="d-none d-lg-block">
      @csrf
      <div class="input-group">
        <input type="text" list="product-list" class="form-control" name="search" placeholder="Search">
      ...
      <datalist id="product-list">
        @foreach (\App\Models\Product::select('name')->get() as $product)
